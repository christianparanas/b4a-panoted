...
__c.LogImpl("99633795",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("99502741","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("99895940","Only top page can be closed",0);
...
__c.LogImpl("99895943","First page cannot be closed",0);
...
__c.LogImpl("910551299","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 399;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("910551300","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("99437211","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
__c.LogImpl("911206670","Too many parameters",0);
 break; }
}
;
